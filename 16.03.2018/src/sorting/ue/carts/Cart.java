...
public class Cart implements Comparable<Cart>{
	...
	private int numArticles, totalItems; 
	...
	public String toString() {
		return "Carts [username=" + username + ", numArticles=" + numArticles + ", totalItems=" + totalItems
	...
	public int compareTo(Cart o) {
		if(getTotalAmount() > o.getTotalAmount()) return -1; 
		if(getTotalAmount() == o.getTotalAmount()) return 0; 
		return 1; 
	} 
